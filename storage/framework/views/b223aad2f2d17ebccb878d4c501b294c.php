...
<div class="space-y-gr-xl">
        ...
        <div class="relative z-10 flex items-center justify-between">
            ...
            <div class="text-right space-y-gr-sm">
                <div class="bg-white/10 backdrop-blur-sm rounded-xl px-gr-lg py-gr-md border border-white/20">
                    <p class="text-body text-gray-200 font-medium mb-gr-xs" id="current-date"><?php echo e(now()->format('l, F j, Y')); ?></p>
                    <p class="text-h2 font-bold text-lgu-highlight" id="current-time-main"><?php echo e(now()->format('g:i A')); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-gr-lg items-stretch">
        <!-- Payment Pending -->
        <a href="<?php echo e(route('admin.payment-queue')); ?>" class="bg-yellow-50 border border-yellow-200 rounded-xl p-gr-lg shadow-sm hover:shadow-md transition-all hover:scale-105">
            <div class="flex items-center h-full">
                ...
                <div class="ml-gr-sm">
                    ...
                    <p class="text-h2 font-bold text-amber-900"><?php echo e($stats['payment_pending']); ?></p>
                </div>
            </div>
        </a>

        <!-- Payment Verification -->
        <a href="<?php echo e(route('admin.bookings.index')); ?>?status=paid" class="bg-blue-50 border border-blue-200 rounded-xl p-gr-lg shadow-sm hover:shadow-md transition-all hover:scale-105">
            <div class="flex items-center h-full">
                <div class="flex-shrink-0">
                ...
                <div class="ml-gr-sm">
                    ...
                    <p class="text-h2 font-bold text-blue-900"><?php echo e($stats['payment_verification']); ?></p>
                </div>
            </div>
        </a>

        <!-- Confirmed Bookings -->
        <a href="<?php echo e(route('admin.bookings.index')); ?>?status=confirmed" class="bg-green-50 border border-green-200 rounded-xl p-gr-lg shadow-sm hover:shadow-md transition-all hover:scale-105">
            <div class="flex items-center h-full">
                <div class="flex-shrink-0">
                ...
                <div class="ml-gr-sm">
                    ...
                    <p class="text-h2 font-bold text-emerald-900"><?php echo e($stats['confirmed']); ?></p>
                </div>
            </div>
        </a>

        <!-- Today's Events -->
        <a href="<?php echo e(route('admin.calendar')); ?>" class="bg-purple-50 border border-purple-200 rounded-xl p-gr-lg shadow-sm hover:shadow-md transition-all hover:scale-105">
            <div class="flex items-center h-full">
                <div class="flex-shrink-0">
                ...
                <div class="ml-gr-sm">
                    ...
                    <p class="text-h2 font-bold text-purple-900"><?php echo e($stats['todays_events']); ?></p>
                </div>
            </div>
        </a>
    </div>
        ...
        <div class="lg:col-span-2 space-y-gr-lg">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-lgu-stroke p-gr-lg">
                ...
                <div class="grid grid-cols-2 gap-gr-md">
                    <div class="bg-green-50 rounded-xl p-gr-md border border-green-200">
                        ...
                        <p class="text-h2 font-bold text-green-900">₱<?php echo e(number_format($stats['total_revenue'], 2)); ?></p>
                    ...
                    <div class="bg-blue-50 rounded-xl p-gr-md border border-blue-200">
                        ...
                        <p class="text-h2 font-bold text-blue-900">₱<?php echo e(number_format($stats['monthly_revenue'], 2)); ?></p>
                        <p class="text-caption text-blue-600"><?php echo e(\Carbon\Carbon::now()->format('F Y')); ?></p>
        </div>
    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-lgu-stroke p-gr-lg">
                ...
                <div class="bg-lgu-highlight/10 rounded-xl p-gr-md border-2 border-lgu-highlight/20">
                    <p class="text-h2 font-bold text-lgu-headline"><?php echo e($stats['popular_facility']['name']); ?></p>
                    <p class="text-body text-lgu-paragraph"><?php echo e($stats['popular_facility']['count']); ?> booking(s) this month</p>
                            </div>
                        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-lgu-stroke p-gr-lg">
                ...
                <div class="space-y-gr-sm">
                    <div class="flex items-center justify-between py-gr-xs border-b border-gray-100">
                        ...
                        <span class="text-body font-semibold text-lgu-headline"><?php echo e($stats['total_facilities']); ?></span>
                            </div>
                    <div class="flex items-center justify-between py-gr-xs border-b border-gray-100">
                        <span class="text-small text-gray-600">Pending Verification</span>
                        <span class="text-body font-semibold text-yellow-600"><?php echo e($stats['pending_verification']); ?></span>
                        </div>
                    <div class="flex items-center justify-between py-gr-xs">
                        <span class="text-small text-gray-600">Expired (Unpaid)</span>
                        <span class="text-body font-semibold text-orange-600"><?php echo e($stats['expired']); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-lgu-stroke p-gr-lg">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-gr-sm">
                    <a href="<?php echo e(route('admin.payment-queue')); ?>" 
        ...
        <div class="space-y-gr-lg">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-lgu-stroke p-gr-lg">
                ...
                <?php if($recentBookings->count() > 0): ?>
                    <div class="space-y-gr-sm">
                        <?php $__currentLoopData = $recentBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                        <p class="text-small font-semibold text-lgu-headline"><?php echo e($booking->facility->name ?? 'N/A'); ?></p>
                                        <p class="text-caption text-lgu-paragraph"><?php echo e($booking->purpose ?? 'No purpose specified'); ?></p>
                                        <p class="text-caption text-gray-500">
                                            <?php echo e($booking->start_time ? \Carbon\Carbon::parse($booking->start_time)->format('M j, Y @ g:i A') : 'No date'); ?>

                                        </p>
                                </div>
                                    <span class="inline-flex items-center px-gr-xs py-1 rounded-full text-caption font-medium
                                        <?php if($booking->status === 'confirmed'): ?> bg-purple-100 text-purple-800
                                        <?php elseif($booking->status === 'paid'): ?> bg-blue-100 text-blue-800
                                        <?php elseif($booking->status === 'staff_verified'): ?> bg-green-100 text-green-800
                    ...
                    <div class="mt-gr-md">
                        <a href="<?php echo e(route('admin.bookings.index')); ?>" class="text-small text-lgu-button hover:underline font-medium">
                            View All Bookings →
                        </a>
                    </div>
                <?php else: ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof ApexCharts !== 'undefined') {
        ...
        if (chartElement) {
            ...
            const revenueData = <?php echo json_encode($stats['daily_revenue_data'], 15, 512) ?>;
            const revenueLabels = <?php echo json_encode($stats['daily_revenue_labels'], 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\local-government-unit-1-ph.com\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>