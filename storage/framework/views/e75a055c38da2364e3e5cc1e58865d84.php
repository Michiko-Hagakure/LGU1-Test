        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="<?php echo e(route('citizen.reservations', ['status' => 'active', 'search' => $search])); ?>" 
                    ...
                    <a href="<?php echo e(route('citizen.reservations', ['status' => 'completed', 'search' => $search])); ?>" 
...
function liveSearch(query) {
    ...
    searchTimeout = setTimeout(() => {
        ...
        window.location.href = `<?php echo e(route('citizen.reservations')); ?>?status=${currentStatus}&search=${encodeURIComponent(query)}`;
    }, 500);
}
...
<?php echo $__env->make('layouts.citizen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/citizen/reservations/index.blade.php ENDPATH**/ ?>