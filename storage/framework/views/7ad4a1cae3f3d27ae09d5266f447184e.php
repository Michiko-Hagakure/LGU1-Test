...
<?php $__env->startSection('page-subtitle', 'Manage your saved payment methods'); ?>
...
<div class="pb-gr-2xl">
    ...
    <div class="flex justify-between items-center mb-gr-lg">
        ...
        <a href="<?php echo e(route('citizen.payment-methods.create')); ?>" class="btn-primary">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-gr-2xl text-center">
        ...
        <a href="<?php echo e(route('citizen.payment-methods.create')); ?>" class="btn-primary inline-flex items-center">
            <i data-lucide="plus" class="w-4 h-4 mr-gr-xs"></i>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gr-lg">
        ...
        <div class="bg-white rounded-xl shadow-sm border-2 <?php echo e($method->is_default ? 'border-lgu-green' : 'border-gray-200'); ?> p-gr-lg relative">
            ...
            <div class="flex items-start justify-between mb-gr-md">
                <div class="w-12 h-12 rounded-lg flex items-center justify-center
                    <?php if($method->payment_type == 'gcash'): ?> bg-blue-100
                    <?php elseif($method->payment_type == 'paymaya'): ?> bg-green-100
            ...
            <h3 class="text-h6 font-bold text-gray-900 mb-gr-xs">
                <?php echo e(ucfirst(str_replace('_', ' ', $method->payment_type))); ?>

            </h3>
            <p class="text-small text-gray-600 mb-gr-3xs"><?php echo e($method->account_name); ?></p>
            <p class="text-small font-mono text-gray-500 mb-gr-md"><?php echo e(substr($method->account_number, 0, -4) . str_repeat('*', 4)); ?></p>

            <div class="pt-gr-md border-t border-gray-200 flex items-center space-x-gr-sm">
                <?php if(!$method->is_default): ?>
                <button onclick="setAsDefault(<?php echo e($method->id); ?>)" class="flex-1 text-lgu-green hover:text-lgu-green-dark font-medium text-small">
                    Set as Default
                </button>
                <?php endif; ?>
                <a href="<?php echo e(route('citizen.payment-methods.edit', $method->id)); ?>" class="text-gray-600 hover:text-gray-900">
                    <i data-lucide="edit" class="w-4 h-4"></i>
                </a>
                <button onclick="confirmDelete(<?php echo e($method->id); ?>)" class="text-red-600 hover:text-red-700">
...
<?php echo $__env->make('layouts.citizen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/citizen/payment-methods/index.blade.php ENDPATH**/ ?>