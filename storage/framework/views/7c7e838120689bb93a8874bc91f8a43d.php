...
<?php $__env->startSection('title', 'Reports & Analytics Hub - Admin'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span class="text-sm font-semibold text-lgu-headline"><?php echo e(now()->format('M d, Y g:i A')); ?></span>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-lgu-primary">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-lgu-headline mt-1">₱<?php echo e(number_format($totalRevenue ?? 0, 2)); ?></h3>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-lgu-secondary">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-lgu-headline mt-1"><?php echo e(number_format($totalBookings ?? 0)); ?></h3>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-lgu-tertiary">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-lgu-headline mt-1"><?php echo e(number_format($activeCitizens ?? 0)); ?></h3>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-lgu-highlight">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-lgu-headline mt-1"><?php echo e(number_format($facilityUtilization ?? 0, 1)); ?>%</h3>
                </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <!-- Revenue Report -->
            <a href="<?php echo e(route('admin.analytics.revenue-report')); ?>" class="group block p-4 border-2 border-gray-200 rounded-lg hover:border-lgu-primary hover:shadow-md transition-all duration-200">
            ...
            <!-- Budget Analysis -->
            <a href="<?php echo e(route('admin.budget.index')); ?>" class="group block p-4 border-2 border-gray-200 rounded-lg hover:border-lgu-primary hover:shadow-md transition-all duration-200">
                <div class="flex items-start justify-between mb-3">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <!-- Booking Statistics -->
            <a href="<?php echo e(route('admin.analytics.booking-statistics')); ?>" class="group block p-4 border-2 border-gray-200 rounded-lg hover:border-lgu-secondary hover:shadow-md transition-all duration-200">
                <div class="flex items-start justify-between mb-3">
            ...
            <a href="<?php echo e(route('admin.analytics.facility-utilization')); ?>" class="group block p-4 border-2 border-gray-200 rounded-lg hover:border-lgu-secondary hover:shadow-md transition-all duration-200">
                <div class="flex items-start justify-between mb-3">
            ...
            <!-- Operational Metrics -->
            <a href="<?php echo e(route('admin.analytics.operational-metrics')); ?>" class="group block p-4 border-2 border-gray-200 rounded-lg hover:border-lgu-secondary hover:shadow-md transition-all duration-200">
                <div class="flex items-start justify-between mb-3">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <!-- Citizen Analytics -->
            <a href="<?php echo e(route('admin.analytics.citizen-analytics')); ?>" class="group block p-4 border-2 border-gray-200 rounded-lg hover:border-lgu-tertiary hover:shadow-md transition-all duration-200">
                <div class="flex items-start justify-between mb-3">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/admin/analytics/index.blade.php ENDPATH**/ ?>