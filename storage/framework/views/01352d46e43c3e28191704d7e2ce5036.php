<?php $__env->startSection('page-title', 'Request Facility Maintenance'); ?>
<?php $__env->startSection('page-subtitle', 'Submit maintenance request to Community Infrastructure Management'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <form action="<?php echo e(URL::signedRoute('admin.community-maintenance.store')); ?>" method="POST" id="maintenanceRequestForm">
        <?php echo csrf_field(); ?>
            ...
            <div class="p-6 space-y-6">
                <div>
                    ...
                    <select id="facility_id" name="facility_id" 
                        ...
                        <option value="<?php echo e($facility->facility_id); ?>" 
                            data-address="<?php echo e($facility->name); ?>, <?php echo e($facility->full_address ?? $facility->address); ?>"
                            <?php echo e(old('facility_id') == $facility->facility_id ? 'selected' : ''); ?>>
                ...
                <div>
                    ...
                    <input type="text" id="unit_number" name="unit_number" 
                        value="<?php echo e(old('unit_number')); ?>" 
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="resident_name" name="resident_name" 
                        value="<?php echo e(old('resident_name', session('user_name'))); ?>" 
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lgu-highlight focus:border-lgu-highlight transition-colors"
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select id="report_type" name="report_type" 
                            ...
                            <option value="<?php echo e($type['value']); ?>" <?php echo e(old('report_type', 'maintenance') == $type['value'] ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <select id="priority" name="priority" 
                            ...
                            <option value="<?php echo e($level['value']); ?>" <?php echo e(old('priority', 'medium') == $level['value'] ? 'selected' : ''); ?>>
                                <?php echo e($level['label']); ?> - <?php echo e($level['description']); ?>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="5" 
                        ...
                        placeholder="Provide a detailed description of the maintenance issue, including when it started, severity of damage, and any safety concerns..." required><?php echo e(old('description')); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-end gap-4">
            <a href="<?php echo e(URL::signedRoute('admin.community-maintenance.index')); ?>" class="px-6 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors font-medium">
                View My Reports
            </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\local-government-unit-1-ph.com\resources\views/admin/community-maintenance/create.blade.php ENDPATH**/ ?>