...
<?php $__env->startSection('page-title', 'Edit Your Review'); ?>
<?php $__env->startSection('page-subtitle', 'Update your feedback for this facility'); ?>

<?php $__env->startSection('page-content'); ?>
<div class="max-w-4xl mx-auto space-y-6">
    <!-- Back Button -->
    <div>
        <a href="<?php echo e(route('citizen.reviews.index')); ?>" 
        ...
        <div class="p-6">
            <div class="flex gap-6">
                <?php if($review->facility_image): ?>
                    <img src="<?php echo e(asset('storage/' . $review->facility_image)); ?>" 
                         alt="<?php echo e($review->facility_name); ?>" 
                ...
                <div class="flex-1">
                    <h3 class="text-2xl font-bold text-lgu-headline mb-2"><?php echo e($review->facility_name); ?></h3>
                    <p class="text-sm text-gray-600 mb-3"><?php echo e($review->facility_address); ?></p>
                    
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <p class="text-xs text-gray-500 font-medium">Event Date</p>
                            <p class="text-sm font-semibold text-gray-900">
                                <?php echo e(\Carbon\Carbon::parse($review->start_time)->format('F d, Y')); ?>
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-gray-900">
                                <?php echo e(\Carbon\Carbon::parse($review->start_time)->format('g:i A')); ?> - 
                                <?php echo e(\Carbon\Carbon::parse($review->end_time)->format('g:i A')); ?>
    ...
    <!-- Review Form -->
    <form action="<?php echo e(route('citizen.reviews.update', $review->id)); ?>" method="POST" class="bg-white shadow rounded-lg overflow-hidden">
        <?php echo csrf_field(); ?>
        ...
        <div class="p-6 space-y-6">
            ...
            <div>
                ...
                <div class="flex items-center gap-2">
                    <div id="star-rating" class="flex gap-1">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            <button type="button" 
                                ...
                                <svg class="w-12 h-12 <?php echo e($i <= $review->rating ? 'text-yellow-400' : 'text-gray-300'); ?> hover:text-yellow-400 transition-colors" 
                                     fill="currentColor" 
                                     viewBox="0 0 20 20">
                    ...
                    <span id="rating-text" class="text-lg font-semibold text-lgu-highlight ml-2">
                        <?php
                            $labels = [1 => 'Poor', 2 => 'Fair', 3 => 'Good', 4 => 'Very Good', 5 => 'Excellent'];
                        ?>
                        <?php echo e($labels[$review->rating] ?? 'No rating selected'); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea 
                    ...
                    placeholder="Tell us about your experience with this facility. What did you like? What could be improved?"><?php echo e(old('review', $review->review)); ?></textarea>
...
<?php echo $__env->make('layouts.citizen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\local-government-unit-1-ph.com\resources\views/citizen/reviews/edit.blade.php ENDPATH**/ ?>