...
<div class="p-6 max-w-4xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-lgu-headline mb-2">Edit Message Template</h1>
        <p class="text-lgu-paragraph">Update email, SMS, or in-app notification template</p>
    </div>
    ...
    <form action="<?php echo e(route('admin.templates.update', $template->id)); ?>" method="POST" class="bg-white rounded-2xl shadow-lg p-8">
        <?php echo csrf_field(); ?>
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="type" id="messageType" required
                        ...
                        <option value="email" <?php echo e(old('type', $template->type) === 'email' ? 'selected' : ''); ?>>Email</option>
                        <option value="sms" <?php echo e(old('type', $template->type) === 'sms' ? 'selected' : ''); ?>>SMS</option>
                        <option value="in-app" <?php echo e(old('type', $template->type) === 'in-app' ? 'selected' : ''); ?>>In-App Notification</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="category" required
                        ...
                        <option value="booking" <?php echo e(old('category', $template->category) === 'booking' ? 'selected' : ''); ?>>Booking</option>
                        <option value="payment" <?php echo e(old('category', $template->category) === 'payment' ? 'selected' : ''); ?>>Payment</option>
                        <option value="reminder" <?php echo e(old('category', $template->category) === 'reminder' ? 'selected' : ''); ?>>Reminder</option>
                        <option value="general" <?php echo e(old('category', $template->category) === 'general' ? 'selected' : ''); ?>>General</option>
                    </select>
                </div>
            </div>

            <!-- Subject (Email only) -->
            <div id="subjectField" class="<?php echo e($template->type !== 'email' ? 'hidden' : ''); ?>">
                <label class="block text-sm font-bold text-lgu-headline mb-2">
            ...
            <div>
                ...
                <textarea name="body" rows="8" required
                          ...
                          class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-lgu-stroke focus:outline-none font-mono text-sm"><?php echo e(old('body', $template->body)); ?></textarea>
                <p class="text-xs text-gray-500 mt-1">Use {{{{variable_name}}}} for dynamic content</p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\local-government-unit-1-ph.com\resources\views/admin/templates/edit.blade.php ENDPATH**/ ?>