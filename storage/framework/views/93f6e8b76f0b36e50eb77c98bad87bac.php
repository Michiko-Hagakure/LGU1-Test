...
<div class="px-gr-md mb-gr-lg">
    ...
    <ul class="space-y-gr-xs">
        <li>
            <a href="#" class="sidebar-link flex items-center px-gr-sm py-gr-xs text-small font-medium rounded-lg transition-colors duration-200 
...
<?php /**PATH D:\xampp\htdocs\local-government-unit-1-ph.com\resources\views/components/sidebar/admin-menu.blade.php ENDPATH**/ ?>