...
<?php $__env->startSection('page-subtitle', 'Update staff account information'); ?>
    ...
    <div class="bg-white rounded-xl shadow-md p-gr-lg border-2 border-lgu-stroke">
        ...
        <div class="flex items-center gap-gr-sm mb-gr-lg">
            ...
            <div>
                ...
                <p class="text-sm text-lgu-paragraph">Update <?php echo e($staff->full_name); ?>'s information</p>
            </div>
        </div>

        
        <form method="POST" action="<?php echo e(route('admin.staff.update', $staff->id)); ?>" class="space-y-gr-md">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="<?php echo e(old('name', $staff->full_name)); ?>" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="tel" name="phone" id="phone" value="<?php echo e(old('phone', $staff->mobile_number)); ?>" required
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($city->id); ?>" <?php echo e(old('city_id', $staff->city_id) == $city->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/admin/staff/edit.blade.php ENDPATH**/ ?>