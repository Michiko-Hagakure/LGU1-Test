...
<?php $__env->startSection('page-subtitle', 'Verify booking details and documents'); ?>
    ...
    <div class="lg:col-span-2 space-y-gr-lg">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-lgu-stroke p-gr-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-gr-md">
                <div>
                    ...
                    <p class="text-body font-semibold text-gray-900 mt-1"><?php echo e($booking->facility_name); ?></p>
                </div>
                <div>
                    <label class="text-caption font-semibold text-gray-500 uppercase">Location</label>
                    <p class="text-body font-semibold text-gray-900 mt-1"><?php echo e($booking->city_name); ?></p>
                </div>
                <div>
                    <label class="text-caption font-semibold text-gray-500 uppercase">Event Date</label>
                    <p class="text-body font-semibold text-gray-900 mt-1"><?php echo e(\Carbon\Carbon::parse($booking->start_time)->format('F d, Y')); ?></p>
                </div>
                <div>
                    ...
                    <p class="text-body font-semibold text-gray-900 mt-1">
                        <?php echo e(\Carbon\Carbon::parse($booking->start_time)->format('g:i A')); ?> - <?php echo e(\Carbon\Carbon::parse($booking->end_time)->format('g:i A')); ?>

                    </p>
                </div>
                <div>
                    <label class="text-caption font-semibold text-gray-500 uppercase">Expected Attendees</label>
                    <p class="text-body font-semibold text-gray-900 mt-1"><?php echo e(number_format($booking->expected_attendees)); ?> people</p>
                </div>
                <div>
                    <label class="text-caption font-semibold text-gray-500 uppercase">Event Purpose</label>
                    <p class="text-body font-semibold text-gray-900 mt-1"><?php echo e($booking->purpose ?? 'N/A'); ?></p>
                </div>
                <div class="md:col-span-2">
                    <label class="text-caption font-semibold text-gray-500 uppercase">Event Description</label>
                    <p class="text-body text-gray-700 mt-1"><?php echo e($booking->event_description ?? 'No description provided'); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-lgu-stroke p-gr-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-gr-md">
                <div>
                    ...
                    <p class="text-body font-semibold text-gray-900 mt-1"><?php echo e($user->full_name ?? 'N/A'); ?></p>
                </div>
                <div>
                    <label class="text-caption font-semibold text-gray-500 uppercase">Email</label>
                    <p class="text-body font-semibold text-gray-900 mt-1"><?php echo e($user->email); ?></p>
                </div>
                <div>
                    <label class="text-caption font-semibold text-gray-500 uppercase">Mobile Number</label>
                    <p class="text-body font-semibold text-gray-900 mt-1"><?php echo e($user->mobile_number ?? 'N/A'); ?></p>
                </div>
                <div>
                    <label class="text-caption font-semibold text-gray-500 uppercase">Birthdate</label>
                    <p class="text-body font-semibold text-gray-900 mt-1"><?php echo e($user->birthdate ? \Carbon\Carbon::parse($user->birthdate)->format('F d, Y') : 'N/A'); ?></p>
                </div>
                <div>
                    <label class="text-caption font-semibold text-gray-500 uppercase">Gender</label>
                    <p class="text-body font-semibold text-gray-900 mt-1"><?php echo e($user->gender ?? 'N/A'); ?></p>
                </div>
                <div>
                    <label class="text-caption font-semibold text-gray-500 uppercase">Civil Status</label>
                    <p class="text-body font-semibold text-gray-900 mt-1"><?php echo e($user->civil_status ?? 'N/A'); ?></p>
                </div>
                <div class="md:col-span-2">
                    <label class="text-caption font-semibold text-gray-500 uppercase">Current Address</label>
                    <p class="text-body font-semibold text-gray-900 mt-1">
                        <?php if($user->current_address || $user->barangay || $user->philippineCity): ?>
                            <?php echo e($user->current_address ?? ''); ?>

                            <?php if($user->current_address && ($user->barangay || $user->philippineCity)): ?>, <?php endif; ?>
                            <?php if($user->barangay): ?>
                                Barangay <?php echo e($user->barangay->name); ?>

                                <?php if($user->philippineCity): ?>, <?php endif; ?>
                            <?php endif; ?>
                            <?php if($user->philippineCity): ?>
                                <?php echo e($user->philippineCity->name); ?>
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center justify-between py-3 border-b border-gray-200 last:border-0">
                    <div>
                        ...
                        <p class="text-small text-gray-600">Quantity: <?php echo e($item->pivot->quantity); ?></p>
                    </div>
                    <div class="text-right">
                        <p class="font-semibold text-gray-900">₱<?php echo e(number_format($item->pivot->price_per_unit * $item->pivot->quantity, 2)); ?></p>
                        <p class="text-small text-gray-600">₱<?php echo e(number_format($item->pivot->price_per_unit, 2)); ?> × <?php echo e($item->pivot->quantity); ?></p>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-lgu-stroke p-gr-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-gr-sm">
                ...
                <button type="button" onclick="openDocumentModal('<?php echo e(asset('storage/' . $doc->path)); ?>', '<?php echo e($doc->type); ?>')"
                   class="flex items-center p-3 rounded-lg border border-gray-300 hover:border-lgu-button hover:bg-gray-50 transition-colors cursor-pointer">
                    ...
                    <div class="flex-1 min-w-0 text-left">
                        <p class="text-small font-medium text-gray-900 truncate"><?php echo e($doc->type); ?></p>
    ...
    <div class="lg:col-span-1">
        <div class="sticky top-6 space-y-gr-md">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-lgu-stroke p-gr-md">
                ...
                <div class="space-y-2 mb-4">
                    <div class="flex justify-between text-small">
                        ...
                        <span class="font-semibold text-gray-900">₱<?php echo e(number_format($booking->base_rate ?? 0, 2)); ?></span>
                    </div>
                    <?php if(count($equipment) > 0): ?>
                    <div class="flex justify-between text-small">
                        <span class="text-gray-600">Equipment</span>
                        <span class="font-semibold text-gray-900">₱<?php echo e(number_format($equipment->sum(function($item) { return $item->pivot->price_per_unit * $item->pivot->quantity; }), 2)); ?></span>
                    </div>
                    <?php endif; ?>
                    
                    <?php if(($booking->total_discount ?? 0) > 0): ?>
                    <div class="mt-2 pt-2 border-t border-gray-100">
                        <?php if(($booking->resident_discount_amount ?? 0) > 0): ?>
                        <div class="flex justify-between text-small">
                            <span class="text-green-600">
                                <i data-lucide="badge-percent" class="w-3 h-3 inline mr-1"></i>
                                Resident Discount (<?php echo e($booking->resident_discount_rate); ?>%)
                            </span>
                            <span class="font-semibold text-green-600">-₱<?php echo e(number_format($booking->resident_discount_amount, 2)); ?></span>
                        </div>
                        <?php endif; ?>
                        <?php if(($booking->special_discount_amount ?? 0) > 0): ?>
                        <div class="flex justify-between text-small mt-1">
                            <span class="text-green-600">
                                <i data-lucide="sparkles" class="w-3 h-3 inline mr-1"></i>
                                <?php echo e(ucfirst(str_replace('_', ' ', $booking->special_discount_type ?? 'Special'))); ?> (<?php echo e($booking->special_discount_rate); ?>%)
                            </span>
                            <span class="font-semibold text-green-600">-₱<?php echo e(number_format($booking->special_discount_amount, 2)); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                ...
                <div class="pt-4 border-t border-gray-200">
                    <div class="flex justify-between">
                        ...
                        <span class="text-h4 font-bold text-lgu-button">₱<?php echo e(number_format($booking->total_amount, 2)); ?></span>
                    </div>
                </div>
            </div>

            <!-- Schedule Conflict Warning -->
            <?php if($booking->status === 'pending' && $conflictCheck['hasConflict']): ?>
            <div class="bg-red-50 border-2 border-red-300 rounded-xl p-gr-md">
                <div class="flex items-start mb-gr-sm">
                    ...
                    <div>
                        ...
                        <p class="text-small text-red-700"><?php echo e($conflictCheck['conflictCount']); ?> booking(s) already approved for overlapping times</p>
                    </div>
                </div>

                <div class="space-y-2 mb-gr-sm">
                    <?php $__currentLoopData = $conflictCheck['conflicts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conflict): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white border border-red-200 rounded-lg p-3">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <p class="font-semibold text-gray-900"><?php echo e($conflict->facility->name); ?></p>
                                <div class="flex items-center gap-4 mt-1 text-xs text-gray-600">
                                    <span class="flex items-center">
                                        ...
                                        <?php echo e(\Carbon\Carbon::parse($conflict->event_date ?? $conflict->start_time)->format('M d, Y')); ?>
                                    ...
                                    <span class="flex items-center">
                                        ...
                                        <?php echo e(\Carbon\Carbon::parse($conflict->start_time)->format('g:i A')); ?> - <?php echo e(\Carbon\Carbon::parse($conflict->end_time)->format('g:i A')); ?>
                                    ...
                                    <span class="flex items-center">
                                        ...
                                        BK-<?php echo e(str_pad($conflict->id, 6, '0', STR_PAD_LEFT)); ?>

                                    </span>
                                </div>
                                <div class="mt-2">
                                    <?php if($conflict->status === 'staff_verified'): ?>
                                        <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-yellow-100 text-yellow-800">
                                            Approved (Awaiting Payment)
                                        </span>
                                    <?php elseif($conflict->status === 'paid' || $conflict->status === 'confirmed'): ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-lgu-stroke p-gr-md">
                ...
                <!-- Verify Form -->
                <form action="<?php echo e(route('staff.bookings.verify', $booking->id)); ?>" method="POST" id="verifyForm" class="mb-gr-sm">
                    <?php echo csrf_field(); ?>
                    <div class="mb-gr-sm">
                ...
                <!-- Reject Form -->
                <form action="<?php echo e(route('staff.bookings.reject', $booking->id)); ?>" method="POST" id="rejectForm">
                    <?php echo csrf_field(); ?>
                ...
                <a href="<?php echo e(route('staff.verification-queue')); ?>" 
                    ...
                    <div class="flex items-center p-gr-sm bg-red-50 border border-red-200 rounded-lg">
                        ...
                        <div>
                            ...
                            <?php if($booking->rejection_reason): ?>
                                <p class="text-xs text-red-600 mt-1"><strong>Reason:</strong> <?php echo e($booking->rejection_reason); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php else: ?>
                    <div class="flex items-center p-gr-sm bg-gray-50 border border-gray-200 rounded-lg">
                        ...
                        <div>
                            <p class="font-semibold text-gray-800 capitalize"><?php echo e(str_replace('_', ' ', $booking->status)); ?></p>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-gr-sm">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-blue-800"><?php echo e($booking->booking_reference ?? 'BK-' . str_pad($booking->id, 6, '0', STR_PAD_LEFT)); ?></p>
                        <p class="text-xs text-blue-700 mt-2">Submitted <?php echo e(\Carbon\Carbon::parse($booking->created_at)->diffForHumans()); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
function confirmVerify() {
    ...
    const hasConflict = <?php echo e($conflictCheck['hasConflict'] ? 'true' : 'false'); ?>;
    const conflictCount = <?php echo e($conflictCheck['conflictCount']); ?>;
...
<?php echo $__env->make('layouts.staff', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/staff/bookings/review.blade.php ENDPATH**/ ?>