...
<?php $__env->startSection('page-subtitle', 'Manage your account information and settings'); ?>
        ...
        <div class="flex flex-col md:flex-row items-center gap-6">
            ...
            <div class="relative group">
                <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-xl">
                    <?php if($avatarPath): ?>
                        <img id="avatarPreview" src="<?php echo e(asset('storage/' . $avatarPath)); ?>" alt="Avatar" class="w-full h-full object-cover">
                    <?php else: ?>
                ...
                <div class="flex flex-wrap items-center justify-center md:justify-start gap-3 mb-3">
                    <?php if($user->city_name ?? null): ?>
                        <span class="px-4 py-1.5 bg-white/20 backdrop-blur-sm rounded-full text-sm font-semibold flex items-center gap-2">
                            ...
                            <?php echo e($user->city_name); ?> Resident
                        </span>
                    <?php endif; ?>
                    <span class="px-4 py-1.5 bg-white/20 backdrop-blur-sm rounded-full text-sm font-semibold flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        Member since <?php echo e(\Carbon\Carbon::parse($user->created_at)->format('M Y')); ?>
            ...
            <div class="flex gap-4">
                <div class="text-center">
                    <div class="text-3xl font-bold"><?php echo e($stats['total_bookings']); ?></div>
                    <div class="text-sm text-white/80">Total Bookings</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold"><?php echo e($stats['active_bookings']); ?></div>
                    ...
                    <div class="border-t-2 border-gray-200 pt-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" value="<?php echo e($displayName); ?>" disabled
                                       class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed">
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <label class="block text-sm font-bold text-gray-900 mb-2">Birthdate</label>
                                    <input type="date" value="<?php echo e($user->birthdate ?? ''); ?>" disabled
                                           class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-gray-900 mb-2">Gender</label>
                                    <input type="text" value="<?php echo e(ucfirst($user->gender ?? 'Not specified')); ?>" disabled
                                           class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-gray-900 mb-2">Mobile Number</label>
                                    <input type="text" name="mobile_number" value="<?php echo e($user->mobile_number ?? $user->phone_number ?? ''); ?>" disabled
                                           class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-lgu-button focus:border-transparent transition-all disabled:bg-gray-100 disabled:cursor-not-allowed">
                                </div>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" value="<?php echo e(ucfirst($user->civil_status ?? 'Not specified')); ?>" disabled
                                           class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-gray-900 mb-2">Nationality</label>
                                    <input type="text" value="<?php echo e($user->nationality ?? 'Filipino'); ?>" disabled
                                           class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea rows="2" disabled
                                          class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed"><?php echo e($user->current_address ?? 'Not specified'); ?></textarea>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-bold text-gray-900 mb-2">Region</label>
                                    <input type="text" value="<?php echo e($user->region_name ?? 'Not specified'); ?>" disabled
                                           class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-gray-900 mb-2">Province</label>
                                    <input type="text" value="<?php echo e($user->province_name ?? 'Not specified'); ?>" disabled
                                           class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" value="<?php echo e($user->district_name ?? 'Not specified'); ?>" disabled
                                           class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-gray-900 mb-2">Barangay</label>
                                    <input type="text" value="<?php echo e($user->barangay_name ?? 'Not specified'); ?>" disabled
                                           class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed">
                                </div>
                                <div>
                                    <label class="block text-sm font-bold text-gray-900 mb-2">Zip Code</label>
                                    <input type="text" value="<?php echo e($user->zip_code ?? 'Not specified'); ?>" disabled
                                           class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="border-t-2 border-gray-200 pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" value="<?php echo e($user->valid_id_type ?? 'Not specified'); ?>" disabled
                                       class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed">
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-gray-900 mb-2">ID Verification Status</label>
                                <input type="text" value="<?php echo e(ucfirst($user->id_verification_status ?? 'Pending')); ?>" disabled
                                       class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-100 cursor-not-allowed">
                            </div>
                        </div>
                        <?php if($user->valid_id_front_image || $user->valid_id_back_image || $user->selfie_with_id_image): ?>
                        <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                            <?php if($user->valid_id_front_image): ?>
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Valid ID - Front Side</label>
                                <img src="<?php echo e(asset($user->valid_id_front_image)); ?>" alt="ID Front" class="w-full h-48 object-cover rounded-lg border-2 border-gray-200 cursor-pointer hover:border-lgu-button transition-all" onclick="window.open('<?php echo e(asset($user->valid_id_front_image)); ?>', '_blank')">
                            </div>
                            <?php endif; ?>
                            <?php if($user->valid_id_back_image): ?>
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Valid ID - Back Side</label>
                                <img src="<?php echo e(asset($user->valid_id_back_image)); ?>" alt="ID Back" class="w-full h-48 object-cover rounded-lg border-2 border-gray-200 cursor-pointer hover:border-lgu-button transition-all" onclick="window.open('<?php echo e(asset($user->valid_id_back_image)); ?>', '_blank')">
                            </div>
                            <?php endif; ?>
                            <?php if($user->selfie_with_id_image): ?>
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2">Selfie with ID</label>
                                <img src="<?php echo e(asset($user->selfie_with_id_image)); ?>" alt="Selfie" class="w-full h-48 object-cover rounded-lg border-2 border-gray-200 cursor-pointer hover:border-lgu-button transition-all" onclick="window.open('<?php echo e(asset($user->selfie_with_id_image)); ?>', '_blank')">
                            </div>
                            <?php endif; ?>
                        </div>
                        <?php endif; ?>
                    ...
                    <div class="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-bold text-blue-700"><?php echo e($stats['total_bookings']); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-bold text-green-700"><?php echo e($stats['completed_bookings']); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-purple-50 rounded-lg">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-bold text-purple-700">₱<?php echo e(number_format($stats['total_spent'], 2)); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <?php $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-start gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-semibold text-gray-900 truncate"><?php echo e($activity->facility_name); ?></p>
                                    <p class="text-xs text-gray-600"><?php echo e(\Carbon\Carbon::parse($activity->created_at)->diffForHumans()); ?></p>
                                </div>
                            </div>
...
document.getElementById('profileForm').addEventListener('submit', function(e) {
    ...
    fetch('<?php echo e(route('citizen.profile.update')); ?>', {
        method: 'POST',
        body: formData,
        headers: {
...
function uploadAvatar(input) {
    ...
    fetch('<?php echo e(route('citizen.profile.avatar')); ?>', {
        method: 'POST',
        body: formData,
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
...
function removeAvatar() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch('<?php echo e(route('citizen.profile.avatar.remove')); ?>', {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
...
<?php echo $__env->make('layouts.citizen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\local-government-unit-1-ph.com\resources\views/citizen/profile/index.blade.php ENDPATH**/ ?>