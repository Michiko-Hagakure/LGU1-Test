        ...
        <?php $__empty_1 = true; $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition opacity-75">
                ...
                <?php if($template->subject): ?>
                    ...
                    <p class="text-sm text-gray-600 mb-3 truncate"><?php echo e($template->subject); ?></p>
                <?php endif; ?>
                <p class="text-sm text-gray-600 mb-4 line-clamp-3"><?php echo e(Str::limit($template->body, 120)); ?></p>

                <!-- Deletion Info -->
                <div class="mb-4 p-3 bg-red-50 rounded-lg border border-red-200">
                    <p class="text-xs text-gray-700">
                        <strong>Deleted:</strong> <?php echo e(\Carbon\Carbon::parse($template->deleted_at)->format('M d, Y h:i A')); ?>

                    </p>
                    <p class="text-xs text-gray-600 mt-1">
                        <?php echo e(\Carbon\Carbon::parse($template->deleted_at)->diffForHumans()); ?>
                ...
                <div class="flex gap-2 border-t pt-4">
                    <form action="<?php echo e(route('admin.templates.restore', $template->id)); ?>" method="POST" class="flex-1">
                        <?php echo csrf_field(); ?>
                        <button type="button" 
                    ...
                    <form action="<?php echo e(route('admin.templates.force-delete', $template->id)); ?>" method="POST" class="flex-1">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\local-government-unit-1-ph.com\resources\views/admin/templates/trash.blade.php ENDPATH**/ ?>