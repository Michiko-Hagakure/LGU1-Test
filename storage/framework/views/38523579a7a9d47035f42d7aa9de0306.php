...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'LGU Notification'); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="email-container">
        ...
        <div class="email-footer">
            ...
            <p style="margin-top: 15px; font-size: 12px; color: #9ca3af;">
                © <?php echo new \Illuminate\Support\EncodedHtmlString(date('Y')); ?> Local Government Unit. All rights reserved.
            </p>
        </div>
    </div>
</body>
...
<?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/emails/layout.blade.php ENDPATH**/ ?>