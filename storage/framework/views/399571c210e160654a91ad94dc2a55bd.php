...
<?php $__env->startSection('page-title', 'Add New Equipment'); ?>
<?php $__env->startSection('page-subtitle', 'Add equipment item to inventory'); ?>
...
<div class="container mx-auto px-gr-md py-gr-lg max-w-3xl">
    ...
    <form action="<?php echo e(route('admin.equipment.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-gr-md">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="price_per_unit" name="price_per_unit" value="<?php echo e(old('price_per_unit')); ?>" min="0" step="0.01" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" id="quantity_available" name="quantity_available" value="<?php echo e(old('quantity_available', 1)); ?>" min="0" required
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\LGU-PUBLIC-FACILITIES-RESERVATION-SYSTEM\resources\views/admin/equipment/create.blade.php ENDPATH**/ ?>