...
<div class="pb-gr-2xl">
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-gr-lg">
            <form method="POST" action="{{ route('citizen.payment-methods.store') }}">
                @csrf
                ...
                <div class="mb-gr-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-gr-md">
                        <label class="relative cursor-pointer">
                            <input type="radio" name="payment_type" value="gcash" {{ old('payment_type') == 'gcash' ? 'checked' : '' }} class="sr-only peer" required>
                        ...
                        <label class="relative cursor-pointer">
                            <input type="radio" name="payment_type" value="paymaya" {{ old('payment_type') == 'paymaya' ? 'checked' : '' }} class="sr-only peer" required>
                            <div class="border-2 border-gray-200 rounded-lg p-gr-md text-center peer-checked:border-lgu-green peer-checked:bg-lgu-green peer-checked:bg-opacity-5 transition-all">
                        ...
                        <label class="relative cursor-pointer">
                            <input type="radio" name="payment_type" value="bank_transfer" {{ old('payment_type') == 'bank_transfer' ? 'checked' : '' }} class="sr-only peer" required>
                            <div class="border-2 border-gray-200 rounded-lg p-gr-md text-center peer-checked:border-lgu-green peer-checked:bg-lgu-green peer-checked:bg-opacity-5 transition-all">
