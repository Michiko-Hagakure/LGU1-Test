                ...
                <div class="mb-gr-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-gr-md" id="paymentTypeSelector">
                        <div class="payment-type-option relative cursor-pointer" data-value="gcash" onclick="selectPaymentType('gcash')">
                            <input type="radio" name="payment_type" value="gcash" {{ old('payment_type', $paymentMethod->payment_type) == 'gcash' ? 'checked' : '' }} class="hidden" required>
                            <div class="payment-type-card border-2 border-gray-200 rounded-lg p-gr-md text-center hover:border-gray-400 transition-all {{ old('payment_type', $paymentMethod->payment_type) == 'gcash' ? 'border-lgu-green bg-green-50' : '' }}">
                        ...
                        <div class="payment-type-option relative cursor-pointer" data-value="paymaya" onclick="selectPaymentType('paymaya')">
                            <input type="radio" name="payment_type" value="paymaya" {{ old('payment_type', $paymentMethod->payment_type) == 'paymaya' ? 'checked' : '' }} class="hidden" required>
                            <div class="payment-type-card border-2 border-gray-200 rounded-lg p-gr-md text-center hover:border-gray-400 transition-all {{ old('payment_type', $paymentMethod->payment_type) == 'paymaya' ? 'border-lgu-green bg-green-50' : '' }}">
                        ...
                        <div class="payment-type-option relative cursor-pointer" data-value="bank_transfer" onclick="selectPaymentType('bank_transfer')">
                            <input type="radio" name="payment_type" value="bank_transfer" {{ old('payment_type', $paymentMethod->payment_type) == 'bank_transfer' ? 'checked' : '' }} class="hidden" required>
                            <div class="payment-type-card border-2 border-gray-200 rounded-lg p-gr-md text-center hover:border-gray-400 transition-all {{ old('payment_type', $paymentMethod->payment_type) == 'bank_transfer' ? 'border-lgu-green bg-green-50' : '' }}">
