    ...
    <div class="bg-blue-50 border-2 border-blue-200 rounded-xl p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <label class="flex items-center cursor-pointer">
                <input type="checkbox" name="email_enabled" value="1" 
                       {{ DB::connection('auth_db')->table('system_settings')->where('key', 'email_enabled')->value('value') == '1' ? 'checked' : '' }}
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="email_smtp_host" 
                       value="{{ DB::connection('auth_db')->table('system_settings')->where('key', 'email_smtp_host')->value('value') }}"
            ...
            <div>
                ...
                <input type="number" name="email_smtp_port" 
                       value="{{ DB::connection('auth_db')->table('system_settings')->where('key', 'email_smtp_port')->value('value') }}"
                       placeholder="587"
                       class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none">
            </div>
            ...
            <div>
                ...
                <input type="text" name="email_smtp_username" 
                       value="{{ DB::connection('auth_db')->table('system_settings')->where('key', 'email_smtp_username')->value('value') }}"
            ...
            <div>
                ...
                <select name="email_smtp_encryption" 
                        class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none">
                    @php $encryption = DB::connection('auth_db')->table('system_settings')->where('key', 'email_smtp_encryption')->value('value'); @endphp
            ...
            <div>
                ...
                <input type="email" name="email_from_address" 
                       value="{{ DB::connection('auth_db')->table('system_settings')->where('key', 'email_from_address')->value('value') }}"
            ...
            <div>
                ...
                <input type="text" name="email_from_name" 
                       value="{{ DB::connection('auth_db')->table('system_settings')->where('key', 'email_from_name')->value('value') }}"
        ...
        <div class="mt-4">
            ...
            <textarea name="email_signature" rows="3"
                      ...
                      class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none">{{ DB::connection('auth_db')->table('system_settings')->where('key', 'email_signature')->value('value') }}</textarea>
        </div>
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <label class="flex items-center cursor-pointer">
                <input type="checkbox" name="sms_enabled" value="1" 
                       {{ DB::connection('auth_db')->table('system_settings')->where('key', 'sms_enabled')->value('value') == '1' ? 'checked' : '' }}
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <select name="sms_provider" 
                    ...
                    @php $provider = DB::connection('auth_db')->table('system_settings')->where('key', 'sms_provider')->value('value'); @endphp
                    <option value="semaphore" {{ $provider === 'semaphore' ? 'selected' : '' }}>Semaphore (Recommended for PH)</option>
                    <option value="twilio" {{ $provider === 'twilio' ? 'selected' : '' }}>Twilio</option>
                    <option value="vonage" {{ $provider === 'vonage' ? 'selected' : '' }}>Vonage</option>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="text" name="sms_sender_name" 
                       value="{{ DB::connection('auth_db')->table('system_settings')->where('key', 'sms_sender_name')->value('value') }}"
                       placeholder="LGU"
                       maxlength="11"
                       class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-green-500 focus:outline-none">
            </div>
