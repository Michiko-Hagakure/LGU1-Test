    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($templates as $template)
            <div class="template-card bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition" 
                ...
                <div class="mb-4">
                    <p class="text-sm text-gray-600">{!! nl2br(e($template->body)) !!}</p>
                </div>

                <!-- Variables -->
                @if($template->variables && count(json_decode($template->variables, true)) > 0)
                ...
                <div class="flex gap-2 border-t pt-4">
                    ...
                    <form action="{{ URL::signedRoute('admin.templates.toggle', $template->id) }}" method="POST" class="inline toggle-form">
                        ...
                        <button type="button" 
                                ...
                                onclick="confirmToggle(this, {{ $template->is_active ? 'true' : 'false' }})">
