...
<div class="p-6 max-w-4xl mx-auto">
    ...
    <form action="{{ URL::signedRoute('admin.templates.update', $template->id) }}" method="POST" class="bg-white rounded-2xl shadow-lg p-8">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="type" id="messageType" required
                        ...
                        <option value="in-app" {{ old('type', $template->type) === 'in-app' ? 'selected' : '' }}>In-App Notification</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="category" required
                        ...
                        <option value="booking" {{ old('category', $template->category) === 'booking' ? 'selected' : '' }}>Booking</option>
            ...
            <!-- Subject (Email only) -->
            <div id="subjectField" class="{{ $template->type !== 'email' ? 'hidden' : '' }}">
                <label class="block text-sm font-bold text-lgu-headline mb-2">
            ...
            <div>
                ...
                <textarea name="body" rows="8" required
                          ...
                          class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-lgu-stroke focus:outline-none font-mono text-sm">{{ old('body', $template->body) }}</textarea>
                <p class="text-xs text-gray-500 mt-1">Use @{{{{variable_name}}}} for dynamic content</p>
